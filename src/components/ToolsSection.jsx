    ...
    <div className="max-w-7xl mx-auto px-4 py-10 lg:py-16 mt-0 relative container">
      ...
      <div className="text-center mb-5 sm:mb-10">
        <h2 className=" text-[22px] lg:text-3xl  font-extrabold mb-0 relative inline-block ">
          <span className="text-[#27548A]">Switch from Excel to ACE CRM in Minutes
          </span>
        </h2>
        ...
        Import your data, skip the learning curve, and start selling smarter — all in just a few clicks.
        </p>
      </div>
     ...
     <div className="grid grid-cols-2 gap-5 sm:gap-8 mt-16 sm:w-1/2 order-2 sm:order-1 ">
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border-t-4 border-green-800 hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="text-gray-600 text-sm sm:text-base">Moving from Excel to ACE CRM is quick and hassle-free, with no complex setups required.</p>
        </div>
        
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border-t-4 border-green-800 hover:shadow-lg transition-shadow duration-300">
          <h3 className="font-bold sm:text-lg mb-2">Enhanced Security</h3>
          <p className="text-gray-600  text-sm sm:text-base">Your business data is protected with enterprise-grade security and encryption protocols.</p>
        </div>
        
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border-t-4 border-green-800 hover:shadow-lg transition-shadow duration-300">
          <h3 className="font-bold sm:text-lg mb-2">Productivity Boost</h3>
          <p className="text-gray-600 text-sm sm:text-base">Streamlined workflows and automation features save time and increase team efficiency.</p>
        </div>
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border-t-4 border-green-800 hover:shadow-lg transition-shadow duration-300">
          <h3 className="font-bold sm:text-lg mb-2">Quick Import</h3>
          <p className="text-gray-600 text-sm sm:text-base">Simply upload your Excel file, and ACE CRM handles the rest in just a few clicks.</p>
        </div>
      </div>
     ...
     <img 
            src={excel} 
            alt="ACE CRM" 
            className="sm:w-[900px] sm:h-[550px] sm:ml-20 "/>
     </div>
